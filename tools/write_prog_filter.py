code = r'''// src/js/programs-filter.js — Live Search & Category Filtering for Zunix Programs
...
'''
with open('/home/stark/zunix/src/js/programs-filter.js', 'w') as f:
    f.write(code)
print("programs-filter.js generated successfully")

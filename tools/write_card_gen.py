code = r'''// src/js/card-generator.js — Dynamic Student ID Card Generator, 3D Tilt & Canvas PNG Export
...
'''
with open('/home/stark/zunix/src/js/card-generator.js', 'w') as f:
    f.write(code)
print("card-generator.js generated successfully")
